...
2. Does the draft lead with what the reader needs and serve the piece's reader and goal?
3. Is the main point front-loaded in the draft, each section, and each paragraph?
4. Do sentences earn their place, with concrete facts, protected details, and direct verbs where the draft supports them?
5. Does the draft use active voice with human subjects where possible?
6. Does the edit keep useful edge and preserve structure unless the structure was hurting the piece?
7. Are long or tangled sentences split when they contain more than one idea?

## Words to cut

1. Are banned words, filler phrases, hedging adverbs, dead metaphors, cliches, and inflated claims removed unless quoted as examples?
...
4. Are pointless triplets, audience-flattery openers, and both-sides hedging replaced with the number, reader, or tradeoff the content supports?
